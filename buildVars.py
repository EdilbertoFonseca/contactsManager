...
addon_info = AddonInfo(
	...
	addon_description=_("""Simple contacts manager for saving phone numbers, emails, and other contact details for personal or professional use.

Shortcut Windows+Alt+L."""),
	# version
	addon_version="2025.6.1",
...
pythonSources: list[str] = ["addon/*.py", "addon/globalPlugins/contactsManager/*.py"]
